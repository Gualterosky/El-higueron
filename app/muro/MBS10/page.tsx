...
const routeData = {
  ...
  style: "Clásica Mixta",
  description: `
    Línea mixta, un comienzo gentil a través de algunos tornillos y un movimiento final interesante en el muro rocoso, donde necesitas colocar algunos seguros de tuerca para alcanzar la reunión a la izquierda.
  `,
  tips: [
    "Ruta mixta: combina deportivo y clásico",
    "Comienzo fácil con buenos tornillos",
    "Se requieren seguros de tuerca en la sección final",
    "Movimiento final técnico e interesante",
    "Buena introducción al escalado mixto",
    "Reunión está a la izquierda del muro",
  ],
...
export default function RouteMBS10Page() {
  return (
