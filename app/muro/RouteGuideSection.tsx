        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-muted-foreground">
              Consulta la guía visual con la ubicación y numeración de todas las rutas del muro Bendito Sea. Puedes ampliarla o descargarla para llevarla contigo.
            </p>
          </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl shadow-md">
              ...
              >
                <Image
                  ...
                  alt="Guía de rutas del muro Bendito Sea"
                  fill
